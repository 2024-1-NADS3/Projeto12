...
public class screen8_game4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        garbageRed = findViewById(R.id.garbageRedS8Game4);
        garbageGreen = findViewById(R.id.garbageGreenS8Game4);
        garbageMarron = findViewById(R.id.garbageMarronS8Game4);
        garbageWhite = findViewById(R.id.garbageWhiteS8Game4);
        ...
        garbageRed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(screen8_game4.this, screen8_wingame4.class);
                startActivity(in);
            }
        });
        garbageGreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(screen8_game4.this, screen8_lostgame4.class);
                startActivity(in);
            }
        });
