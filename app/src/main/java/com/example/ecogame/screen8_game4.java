...
public class screen8_game4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screen8_game4);

        garbageRed = findViewById(R.id.garbageRed2S8Game4);
        garbageGreen = findViewById(R.id.garbageGreen2S8Game4);
        garbageMarron = findViewById(R.id.garbageMarron2S8Game4);
        garbageWhite = findViewById(R.id.garbageWhite2S8Game4);
        ...
        garbageRed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(screen8_game4.this, screen4_lostgame1.class);
                startActivity(in);
            }
        });
        ...
        garbageWhite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(screen8_game4.this, screen11_certificate.class);
                startActivity(in);
            }
        });
    }
    ...
    private void saveFalse(int userId, boolean corL) {
    ...
    private void saveTrue(int userId, boolean corL) {
