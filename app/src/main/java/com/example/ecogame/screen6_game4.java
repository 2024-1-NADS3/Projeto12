...
public class screen6_game4 extends AppCompatActivity {
    ...
    private ImageButton imageButtonS6Game4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.screen6_game4);

        imageView3 = findViewById(R.id.imageView3S6Game4);
        imageView4 = findViewById(R.id.imageView4S6Game4);
        imageView5 = findViewById(R.id.imageView5S6Game4);
        imageView6 = findViewById(R.id.imageView6S6Game4);

        findViewById(R.id.petS6Game4).setOnLongClickListener(new MyOnLongClickListener());

        findViewById(R.id.topleftS6Game4).setOnDragListener(new MyOnDragListener(1));
        findViewById(R.id.toprightS6Game4).setOnDragListener(new MyOnDragListener(2));
        findViewById(R.id.bottomleftS6Game4).setOnDragListener(new MyOnDragListener(3));
        findViewById(R.id.bottomrightS6Game4).setOnDragListener(new MyOnDragListener(4));

        white = findViewById(R.id.bottomrightS6Game4);
        //Return to the beginning of the level/stage
        imageButtonS6Game4 = findViewById(R.id.imageButtonS6Game4);
        imageButtonS6Game4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(screen6_game4.this, screen5_endstep.class);
                startActivity(in);
            }
        });
        consultarUltimoId();
    ...
    class MyOnLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            ...
            View.DragShadowBuilder sb = new View.DragShadowBuilder(findViewById(R.id.petS6Game4));
                ...
                case DragEvent.ACTION_DRAG_ENTERED:
                    ...
                    if (draggedView instanceof ImageView) {
                        ...
                        if (imageView.getDrawable() != null) {
                            ...
                            if (v.getId() == R.id.topleftS6Game4) {
                                //Incorrect option
                                saveFalse(userId, false);
                                Intent intent = new Intent(screen6_game4.this,
                                        screen6_lostgame4.class);
                                startActivity(intent);
                            } else if (v.getId() == R.id.toprightS6Game4) {
                                //Incorrect option
                                saveFalse(userId, false);
                                Intent intent = new Intent(screen6_game4.this,
                                        screen6_lostgame4.class);
                                startActivity(intent);
                            } else if (v.getId() == R.id.bottomleftS6Game4) {
                                //Correct option
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        Intent intent = new Intent(screen6_game4.this,
                                                screen6_wingame4.class);
                                        startActivity(intent);
                                    }
                                }, 1000); // Atraso de 1 segundo (1000 milissegundos)
                            } else if (v.getId() == R.id.bottomrightS6Game4) {
                                //Incorrect option
                                saveFalse(userId, false);
                                Intent intent = new Intent(screen6_game4.this,
                                        screen6_lostgame4.class);
    ...
    private void saveFalse(int userId, boolean corH) {
    ...
    private void saveTrue(int userId, boolean corH) {
