...
public class Tela3b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela3b);

        consultarUltimoId();

        //Navegaçãp
        botaoVermelho = findViewById(R.id.buttonRedT3b);
        botaoVermelho.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveFalse(userId, false);
                Intent in = new Intent(getApplicationContext(), Tela3errora.class);
                startActivity(in);
            }
        });

        botaoAmarelo = findViewById(R.id.buttonYellowT3b);
        botaoAmarelo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveFalse(userId, false);
                Intent in = new Intent(getApplicationContext(), Tela3errorb.class);
                startActivity(in);
            }
        });

        botaoPreto = findViewById(R.id.buttonBlackT3b);
        botaoPreto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveTrue(userId,true);
                Intent in = new Intent(getApplicationContext(), Tela3congratsb.class);
                startActivity(in);
            }
        });

        botaoVerde = findViewById(R.id.buttonGreenT3b);
        ...
        botaoAzul = findViewById(R.id.buttonBlueT3b);
        ...
        botaoLaranja = findViewById(R.id.buttonOrangeT3b);
        ...
        botaoback2 = findViewById(R.id.buttonBack2T3b);
        botaoback2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(getApplicationContext(), Tela3a.class);
                startActivity(in);
            }
        });
    }
