...
public class screen9_confirmdata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screen9_confirmdata);
        ...
        buttonCadastrartT10a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gerarPdf();
                Intent in = new Intent(screen9_confirmdata.this, screen12_endgame.class);
                startActivity(in);
            }
        });
    }
