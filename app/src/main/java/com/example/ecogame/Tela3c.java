...
public class Tela3c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela3c);

        consultarUltimoId();

        //Navegaçãp
        botaoVermelho = findViewById(R.id.buttonRedT3c);
        ...
        botaoAmarelo = findViewById(R.id.buttonYellowT3c);
        ...
        botaoPreto = findViewById(R.id.buttonBlackT3c);
        ...
        botaoVerde = findViewById(R.id.buttonGreenT3c);
        ...
        botaoAzul = findViewById(R.id.buttonBlueT3c);
        ...
        botaoLaranja = findViewById(R.id.buttonOrangeT3c);
        ...
        botaoback2 = findViewById(R.id.buttonBack2T3c);
        botaoback2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(getApplicationContext(), Tela3b.class);
                startActivity(in);
            }
        });
    }
