...
public class screen10_updatedata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screen10_updatedata);
        ...
        buttonConfirmarT10b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gerarPdf();
                Intent in = new Intent(screen10_updatedata.this, screen12_endgame.class);
                startActivity(in);
            }
        });
        ...
        buttonAtualizarT10b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(screen10_updatedata.this, screen9_confirmdata.class);
                startActivity(in);
            }
        });
