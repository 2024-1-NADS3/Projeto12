...
public class screen6_game1 extends AppCompatActivity {
    ...
    private ImageButton imageButtonS6Game1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.screen6_game1);

        imageView3 = findViewById(R.id.imageView3S6Game1);
        imageView4 = findViewById(R.id.imageView4S6Game1);
        imageView5 = findViewById(R.id.imageView5S6Game1);
        imageView6 = findViewById(R.id.imageView6S6Game1);

        findViewById(R.id.petS6Game1).setOnLongClickListener(new screen6_game1.MyOnLongClickListener());

        findViewById(R.id.topleftS6Game1).setOnDragListener(new screen6_game1.MyOnDragListener(1));
        findViewById(R.id.toprightS6Game1).setOnDragListener(new screen6_game1.MyOnDragListener(2));
        findViewById(R.id.bottomleftS6Game1).setOnDragListener(new screen6_game1.MyOnDragListener(3));
        findViewById(R.id.bottomrightS6Game1).setOnDragListener(new screen6_game1.MyOnDragListener(4));

        white = findViewById(R.id.bottomrightS6Game1);

        //Return to the beginning of the level/stage
        imageButtonS6Game1 = findViewById(R.id.imageButtonS6Game1);
        imageButtonS6Game1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(screen6_game1.this, screen5_endstep.class);
                startActivity(in);
            }
        });
    ...
    class MyOnLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            ...
            View.DragShadowBuilder sb = new View.DragShadowBuilder(findViewById(R.id.petS6Game1));
                ...
                case DragEvent.ACTION_DRAG_ENTERED:
                    ...
                    if (draggedView instanceof ImageView) {
                        ...
                        if (imageView.getDrawable() != null) {
                            ...
                            if (v.getId() == R.id.topleftS6Game1) {
                                //Incorrect option
                                saveFalse(userId, false);
                                Intent intent = new Intent(screen6_game1.this,
                                        screen6_lostgame1.class);
                                startActivity(intent);
                            } else if (v.getId() == R.id.toprightS6Game1) {
                                //Incorrect option
                                saveFalse(userId, false);
                                Intent intent = new Intent(screen6_game1.this,
                                        screen6_lostgame1.class);
                                startActivity(intent);
                            } else if (v.getId() == R.id.bottomleftS6Game1) {
                                //Incorrect option
                                saveFalse(userId, false);
                                Intent intent = new Intent(screen6_game1.this,
                                        screen6_lostgame1.class);
                                startActivity(intent);
                            } else if (v.getId() == R.id.bottomrightS6Game1) {
                                //Correct option
